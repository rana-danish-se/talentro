          ...
          >
            ...
            >
              ...
              <div className="border-b border-neutral-200 dark:border-neutral-700 px-6 py-4 flex items-center justify-between">
                ...
                >
                  <X className="w-5 cursor-pointer   h-5 text-neutral-500 dark:text-neutral-400" />
                </button>
              </div>
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="text-xs bg-neutral-100 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-600 rounded px-2 py-1 mt-1"
                    >
              ...
              <div className="border-t border-neutral-200 dark:border-neutral-700 px-6 py-4">
                ...
                <motion.button
                  ...
                  className="w-full cursor-pointer py-3 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-semibold rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {loading ? (
