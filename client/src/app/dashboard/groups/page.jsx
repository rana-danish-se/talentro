...
import { Bell, GroupIcon, MessageCircle } from "lucide-react";
  ...
  return (
    <div className="flex h-[80vh] w-full items-center justify-center p-4">
      ...
      >
        ...
        >
          <GroupIcon     className="h-12 w-12 text-blue-500" />
        </motion.div>
        ...
        <p className="text-gray-500 dark:text-gray-400 max-w-md mx-auto">
                We&apos;re working hard to bring you a comprehensive groups
