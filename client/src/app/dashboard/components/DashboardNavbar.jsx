    ...
    <nav className="px-6 md:px-10 py-3 border-b border-purple-500/20 sticky top-0 backdrop-blur-xl z-50 shadow-lg shadow-purple-500/5">
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div className="hidden lg:flex items-center justify-center gap-2">
          ...
          <motion.button
            onClick={logout}
            className="p-2.5 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors text-gray-600 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            title="Logout"
          >
          ...
          >
            ...
            >
              ...
              <motion.button
                ...
                className="w-full px-5 py-3 rounded-lg flex items-center justify-center gap-2 text-sm font-semibold bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors"
                whileTap={{ scale: 0.95 }}
              >
                <LogOut className="w-5 h-5" />
                Logout
