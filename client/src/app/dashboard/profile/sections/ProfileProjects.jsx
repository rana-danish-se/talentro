                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity ml-4">
                      <motion.button
                        ...
                        className="p-2 cursor-pointer text-purple-400 hover:bg-purple-900/30 rounded-lg transition-all"
                      >
                      ...
                      <motion.button
                        ...
                        className="p-2 cursor-pointer text-red-400 hover:bg-red-900/30 rounded-lg transition-all"
                      >
          ...
          >
            ...
            >
                ...
                <div>
                  ...
                  <div className="flex gap-2 mb-2">
                    ...
                    <motion.button
                      ...
                      type="button"
                      onClick={addSkill}
                      className="px-4 cursor-pointer py-2.5 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-all"
                    >
                      Add
                    </motion.button>
                  </div>
                        ...
                        {previewUrls.map((url, idx) => (
                          ...
                          >
                            ...
                            <button
                              ...
                              className="absolute cursor-pointer top-1 right-1 p-1 bg-red-500/80 text-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
                            >
                              <X className="w-3 h-3" />
                            </button>
                          </div>
              ...
              <div className="sticky bottom-0 bg-neutral-900 border-t border-neutral-700 px-6 py-4 flex justify-end gap-3">
                <button
                  onClick={() => setIsModalOpen(false)}
                  className="px-6 cursor-pointer py-2.5 border border-neutral-700 rounded-lg font-medium text-gray-300 hover:bg-neutral-800 transition-all"
                >
                  Cancel
                </button>
                <motion.button
                  ...
                  className="px-6 cursor-pointer py-2.5 bg-gradient-to-r from-purple-600 to-purple-500 text-white rounded-lg font-medium shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
