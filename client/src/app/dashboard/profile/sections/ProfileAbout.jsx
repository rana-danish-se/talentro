...
const ProfileAbout = () => {
  ...
  return (
    <>
      <section id="about" className="max-w-4xl bg-neutral-950 shadow-2xl my-10 border-neutral-700 border p-10 mx-auto rounded-xl overflow-hidden mt-10">
        ...
        <article className={`mt-10 ${isExpanded?'max-h-auto':'max-h-50'}  overflow-hidden  relative`}>
          <div
            ref={contentRef}
            style={{
