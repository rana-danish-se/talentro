...
const PostJob = () => {
  ...
  const menuItems = [
    { icon: Bookmark, label: "My Jobs", path: "/dashboard/jobs/my-jobs" },
    { icon: Edit2, label: "Create Job", path: "/dashboard/jobs/create-job" },
  ];

  return (
    <div className="sticky top-30 bottom-10 mb-10  max-w-sm space-y-4">
      {/* Main Profile Card */}
          ...
          <div className="absolute -bottom-10 left-4">
            <div className="w-20 h-20 rounded-full border-4 border-white dark:border-neutral-950 overflow-hidden bg-gradient-to-br from-purple-500 to-blue-500">
              <Image
                ...
                alt={profile?.firstName || user?.fullName}
                className="w-full h-full object-cover"
                width={100}
                height={100}
              />
