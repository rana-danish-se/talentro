...
export const getPostComments = async (req, res) => {
  try {
    ...
    // Populate author details from Profile
    ...
    const commentsWithDetails = comments.map((comment) => {
      const profile = profileMap[comment.authorId.toString()];
      return {
        ...comment.toObject(),
        authorId: {
    ...
    let finalComments = commentsWithDetails;
    ...
    if (userId) {
      ...
      finalComments = commentsWithDetails.map((comment) => ({
        ...comment,
